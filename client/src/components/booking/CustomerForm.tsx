                ...
                >
                  ...
                  <div className="flex items-center gap-1.5 ml-2 flex-shrink-0">
                    <Link href={`/agendamento/${appt.manageToken}`}>
                      <button
                        className="text-xs font-medium px-2.5 py-1.5 rounded-lg transition-colors hover:opacity-80 text-white"
                    ...
                    <Link href={`/reagendar/${appt.manageToken}`}>
                      <button className="text-xs font-medium px-2.5 py-1.5 rounded-lg border border-border bg-card hover:bg-muted transition-colors text-foreground">
                        Reagendar
                      </button>
                    </Link>
                  </div>
